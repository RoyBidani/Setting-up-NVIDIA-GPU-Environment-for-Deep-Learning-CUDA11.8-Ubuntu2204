...
# Remove TensorRT and related packages
echo "Removing TensorRT and related packages..."
sudo apt-get --purge remove -y tensorrt python3-libnvinfer-dev libnvinfer-bin libnvinfer-dev libnvinfer-dispatch10 libnvinfer-headers-dev libnvinfer-headers-plugin-dev libnvinfer-lean10 libnvinfer-plugin-dev libnvinfer-plugin10 libnvinfer-vc-plugin10 libnvinfer10
sudo apt-get autoremove -y
sudo apt-get autoclean -y
